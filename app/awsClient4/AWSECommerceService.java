    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(awsClient4.AWSECommerceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = awsClient4.AWSECommerceService.class.getResource(".");
